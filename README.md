...
**Other**
- C (systems programming), WebAssembly
...
- Spring backend for RAF Cloud Manager (permissions, scheduling, async operations)
- Improving portfolio projects and documentation
